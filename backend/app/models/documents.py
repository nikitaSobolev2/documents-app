...
from app.schemas.enums import DocumentStatus, DocumentProcessingTaskStatus
...
class Document(Base):
    ...
    status: Mapped[DocumentStatus] = mapped_column(String(255), nullable=False, default=DocumentStatus.DRAFT)
...
class DocumentProcessingTask(Base):
    ...
    status: Mapped[DocumentProcessingTaskStatus] = mapped_column(String(255), nullable=False, default=DocumentProcessingTaskStatus.PENDING)
